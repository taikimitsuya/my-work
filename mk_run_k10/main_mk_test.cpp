...
using namespace std;
int main() {
    cout << "=== MK-TFHE Test (k=10, N=1024) ===" << endl;
    ...
    cout << "Note: Peak Memory Usage. System may become slow." << endl;
    ...
    cout << "[Step 1] Generating Keys (for 10 parties)..." << endl;
    for(int i=0; i<k; ++i){ 
    ...
    cout << "=== SUCCESS: k=10 Test Finished! ===" << endl;
    return 0;
}
