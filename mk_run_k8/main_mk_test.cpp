...
using namespace std;
int main() {
    cout << "=== MK-TFHE Test (k=8, N=1024) ===" << endl;
    ...
    cout << "Note: Extremely Heavy Calculation. Expect heavy swapping." << endl;
    ...
    cout << "[Step 1] Generating Keys (for 8 parties)..." << endl;
    for(int i=0; i<k; ++i){ 
    ...
    cout << "=== SUCCESS: k=8 Test Finished! ===" << endl;
    return 0;
}
