...
using namespace std;
int main() {
    cout << "=== MK-TFHE Test (k=5, N=1024) ===" << endl;
    ...
    cout << "Note: High Memory Usage Expected." << endl;
    ...
    cout << "[Step 1] Generating Keys (for 5 parties)..." << endl;
    for(int i=0; i<k; ++i){ 
    ...
    cout << "=== SUCCESS: k=5 Test Finished! ===" << endl;
    return 0;
}
