...
using namespace std;
int main() {
    cout << "=== MK-TFHE Test (k=7, N=1024) ===" << endl;
    ...
    cout << "Note: Extremely High Memory Usage. Expect swapping." << endl;
    ...
    cout << "[Step 1] Generating Keys (for 7 parties)..." << endl;
    for(int i=0; i<k; ++i){ 
    ...
    cout << "=== SUCCESS: k=7 Test Finished! ===" << endl;
    return 0;
}
