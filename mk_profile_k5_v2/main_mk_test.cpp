...
int main() {
    cout << "=== MK-TFHE Time Profiling (k=5) ===" << endl;
    ...
    bbii::BBIIParams* bp = mp->sk_params; // 詳細パラメータへのアクセス用
    ...
    cout << "  LWE Dimension (n)  : " << bp->n << endl;
    cout << "  Gadget (l, Bgbit)  : l=" << bp->l << ", Bgbit=" << bp->Bgbit << " (Bg=" << (1<<bp->Bgbit) << ")" << endl;
    cout << "  LWE Noise (alpha)  : " << bp->lwe_alpha << endl;
    cout << "  TLWE Noise (alpha) : " << bp->tlwe_alpha << endl;
    cout << "==================================" << endl;
    cout << endl;
