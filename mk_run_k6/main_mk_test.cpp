...
using namespace std;
int main() {
    cout << "=== MK-TFHE Test (k=6, N=1024) ===" << endl;
    ...
    cout << "Note: Very High Memory & CPU Usage Expected." << endl;
    ...
    cout << "[Step 1] Generating Keys (for 6 parties)..." << endl;
    for(int i=0; i<k; ++i){ 
    ...
    cout << "=== SUCCESS: k=6 Test Finished! ===" << endl;
    return 0;
}
