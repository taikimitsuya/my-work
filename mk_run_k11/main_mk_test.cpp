...
using namespace std;
int main() {
    cout << "=== MK-TFHE Test (k=11, N=1024) ===" << endl;
    ...
    cout << "Warning: Beyond standard limits. Ensure sufficient SWAP space." << endl;
    ...
    cout << "[Step 1] Generating Keys (for 11 parties)..." << endl;
    for(int i=0; i<k; ++i){ 
    ...
    cout << "=== SUCCESS: k=11 Test Finished! ===" << endl;
    return 0;
}
